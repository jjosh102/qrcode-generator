...
public partial class Generator : ComponentBase
{
  ...
  private void SelectType(QRCodeType type)
  {
    selectedType = type;
    _dropdownOpen = false;
  }

  private RenderFragment GetIcon(QRCodeType type) => builder =>
{
  var path = type switch
  {
    QRCodeType.Url => "M13.828 10.172a4 4 0 010 5.656l-1.414 1.414a4 4 0 01-5.656 0l-1.414-1.414a4 4 0 010-5.656M10.172 13.828a4 4 0 005.656 0l1.414-1.414a4 4 0 000-5.656l-1.414-1.414a4 4 0 00-5.656 0",
    QRCodeType.Sms => "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z",
    QRCodeType.Email => "M4 4h16v16H4V4zm2 4l6 4 6-4",
    QRCodeType.VCard => "M4 6h16v12H4V6zm2 2v2h12V8H6zm0 4v2h8v-2H6z",
    QRCodeType.Text => "M4 6h16M4 10h16M4 14h10",
    QRCodeType.Wifi => "M2.05 8.54a16 16 0 0119.9 0M4.93 11.4a12 12 0 0114.14 0M7.76 14.26a8 8 0 018.48 0M12 18h.01",
    QRCodeType.Phone => "M3 5a2 2 0 012-2h3.6a1 1 0 01.97.757l.7 2.8a1 1 0 01-.254.962L8.414 9.414a16 16 0 006.172 6.172l1.895-1.895a1 1 0 01.962-.254l2.8.7a1 1 0 01.757.97V19a2 2 0 01-2 2h-.01C10.603 21 3 13.397 3 4.99V5z",
    QRCodeType.Geo => "M12 2C8.134 2 5 5.134 5 9c0 6.627 7 13 7 13s7-6.373 7-13c0-3.866-3.134-7-7-7z M12 11a2 2 0 100-4 2 2 0 000 4z",
    _ => ""
  };
  ...
  builder.AddMarkupContent(6, $"<path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"{path}\" />");
